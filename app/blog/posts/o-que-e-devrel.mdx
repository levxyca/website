...
description: 'Tudo sobre Developer Relations (DevRel): pilares, diferenças para marketing tradicional, papel de ponte entre empresas e comunidades tech.'
publishedAt: '2025-06-02'
tags: ['devrel', 'developer relations', 'comunidade', 'carreira', 'marketing', 'educação']
author: 'Leticia Leonardo (@levxyca)'
publisher: 'levxyca.com.br'
canonical: 'https://levxyca.com.br/blog/o-que-e-devrel'
summary: 'Escrevi um artigo com tudo o que eu gostaria que tivessem me explicado quando comecei na área. Falo sobre os pilares, as diferenças entre DevRel e marketing tradicional e como vejo meu papel conectando pessoas desenvolvedoras e empresas.'
---
...
[Leia também: Preciso ser dev pra ser DevRel?](./preciso-ser-dev-para-ser-devrel)
